                ...
                <div class="card-body pt-2 pb-4 d-flex align-items-center">
                    ...
                    <div class="d-flex flex-column content-justify-center w-100">
                        ...
                        <div class="d-flex fs-6 fw-semibold align-items-center">
                            ...
                            <!--end::Label-->
                            <!--begin::Stats-->
                            <div class="fw-bolder text-gray-700 text-xxl-end">$7,660
                            </div>
                            <!--end::Stats-->
                        </div>
                        <!--end::Label-->
                        ...
                        <div class="d-flex fs-6 fw-semibold align-items-center my-3">
                            ...
                            <!--end::Label-->
                            <!--begin::Stats-->
                            <div class="fw-bolder text-gray-700 text-xxl-end">$2,820
                            </div>
                            <!--end::Stats-->
                        </div>
                        <!--end::Label-->
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <img src="assets/media/stock/ecommerce/210.png" class="w-50px ms-n1"
                                                    alt="" />
                                            </td>
                                            <td class="ps-0">
                                        ...
                                        <tr>
                                            <td>
                                                <img src="assets/media/stock/ecommerce/215.png" class="w-50px ms-n1"
                                                    alt="" />
                                            </td>
                                            <td class="ps-0">
                                                <a href="apps/ecommerce/catalog/edit-product.html"
                                        ...
                                        <tr>
                                            <td>
                                                <img src="assets/media/stock/ecommerce/209.png" class="w-50px ms-n1"
                                                    alt="" />
                                            </td>
                                            <td class="ps-0">
                                                <a href="apps/ecommerce/catalog/edit-product.html"
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <img src="assets/media/stock/ecommerce/197.png" class="w-50px ms-n1"
                                                    alt="" />
                                            </td>
                                            <td class="ps-0">
                                                <a href="apps/ecommerce/catalog/edit-product.html"
                                        ...
                                        <tr>
                                            <td>
                                                <img src="assets/media/stock/ecommerce/178.png" class="w-50px ms-n1"
                                                    alt="" />
                                            </td>
                                            <td class="ps-0">
                                                <a href="apps/ecommerce/catalog/edit-product.html"
                                        ...
                                        <tr>
                                            <td>
                                                <img src="assets/media/stock/ecommerce/22.png" class="w-50px ms-n1"
                                                    alt="" />
                                            </td>
                                            <td class="ps-0">
                                                <a href="apps/ecommerce/catalog/edit-product.html"
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <img src="assets/media/stock/ecommerce/24.png" class="w-50px ms-n1"
                                                    alt="" />
                                            </td>
                                            <td class="ps-0">
                                                <a href="apps/ecommerce/catalog/edit-product.html"
                                        ...
                                        <tr>
                                            <td>
                                                <img src="assets/media/stock/ecommerce/71.png" class="w-50px ms-n1"
                                                    alt="" />
                                            </td>
                                            <td class="ps-0">
                                                <a href="apps/ecommerce/catalog/edit-product.html"
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <img src="assets/media/stock/ecommerce/41.png" class="w-50px ms-n1"
                                                    alt="" />
                                            </td>
                                            <td class="ps-0">
                                                <a href="apps/ecommerce/catalog/edit-product.html"
                                        ...
                                        <tr>
                                            <td>
                                                <img src="assets/media/stock/ecommerce/63.png" class="w-50px ms-n1"
                                                    alt="" />
                                            </td>
                                            <td class="ps-0">
                                                <a href="apps/ecommerce/catalog/edit-product.html"
                                        ...
                                        <tr>
                                            <td>
                                                <img src="assets/media/stock/ecommerce/59.png" class="w-50px ms-n1"
                                                    alt="" />
                                            </td>
                                            <td class="ps-0">
                                                <a href="apps/ecommerce/catalog/edit-product.html"
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <img src="assets/media/stock/ecommerce/10.png" class="w-50px ms-n1"
                                                    alt="" />
                                            </td>
                                            <td class="ps-0">
                                                <a href="apps/ecommerce/catalog/edit-product.html"
                                        ...
                                        <tr>
                                            <td>
                                                <img src="assets/media/stock/ecommerce/96.png" class="w-50px ms-n1"
                                                    alt="" />
                                            </td>
                                            <td class="ps-0">
                                                <a href="apps/ecommerce/catalog/edit-product.html"
                                        ...
                                        <tr>
                                            <td>
                                                <img src="assets/media/stock/ecommerce/13.png" class="w-50px ms-n1"
                                                    alt="" />
                                            </td>
                                            <td class="ps-0">
                                                <a href="apps/ecommerce/catalog/edit-product.html"
        ...
        <div class="col-xl-4 mb-xl-10">
            ...
            <div class="card h-md-100" dir="ltr">
                ...
                <div class="card-body d-flex flex-column flex-center">
                    ...
                    <div class="mb-2">
                        <!--begin::Title-->
                        <h1 class="fw-semibold text-gray-800 text-center lh-lg">Have
                            you tried
                            <br />new
