<x-default-layout>
    @section('title')
        Create Wrapping Area
    @endsection

    @section('breadcrumbs')
        {{ Breadcrumbs::render('wrapping-areas.create') }}
    @endsection
                ...
                <div class="mb-8 row g-8">
                    <div class="col-md-6">
                        ...
                        <div class="input-group input-group-lg input-group-solid">
                            ...
                            <input type="text" name="meta_title"
                                ...
                                placeholder="SEO optimized title" value="{{ old('meta_title') }}" maxlength="60"
                                required />
                        </div>
                        @error('meta_title')
                            <div class="mt-2 text-danger d-flex align-items-center">
                    ...
                    <div class="col-md-3">
                        ...
                        <select name="is_active" class="form-select form-select-lg form-select-solid"
                            ...
                            <option value="0" {{ old('is_active', false) === false ? 'selected' : '' }}>Inactive
                            </option>
                        </select>
                    </div>
                </div>
                ...
                <div class="mb-8">
                    <div>
                        ...
                        <textarea name="meta_description"
                            ...
                            maxlength="160" required>{{ old('meta_description') }}</textarea>
                    ...
                    <div class="col-lg-8">
                        <div class="mb-7">
                            ...
                            <input type="text" name="main_heading"
                                ...
                                placeholder="Enter main section heading" value="{{ old('main_heading') }}"
                                required />
                            @error('main_heading')
                        ...
                        <div>
                            ...
                            <textarea name="main_description"
                                ...
                                rows="6" placeholder="Enter main section description" required>{{ old('main_description') }}</textarea>
                    ...
                    <div class="col-lg-8">
                        <div class="mb-7">
                            ...
                            <input type="text" name="why_partner_heading"
                                ...
                                value="{{ old('why_partner_heading') }}" required />
                        </div>
                        <div>
                            <label class="mb-3 text-gray-700 form-label fw-bold fs-6">
                            ...
                            <textarea name="why_partner_description" class="form-control form-control-lg form-control-solid" rows="6"
                                required>{{ old('why_partner_description') }}</textarea>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="row g-5">
                                    <div class="col-md-12">
                                        <input type="text" name="features[0][title]"
                                            class="mb-3 form-control form-control-lg" placeholder="Feature Title" />
                ...
                <div class="mb-8 row g-6">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="guide_heading"
                            class="form-control form-control-lg form-control-solid"
                            value="{{ old('guide_heading') }}" required />
                    </div>
                    <div class="col-md-6">
                        <label class="mb-3 text-gray-700 form-label fw-bold fs-6">
                        ...
                        <input type="text" name="guide_description"
                            class="form-control form-control-lg form-control-solid"
                            value="{{ old('guide_description') }}" required />
                    </div>
                </div>
            ...
            <div class="p-10 card-body">
                <div class="mb-7">
                    ...
                    <input type="text" name="why_use_heading"
                        class="form-control form-control-lg form-control-solid" value="{{ old('why_use_heading') }}"
                        required />
                </div>
                <div>
                    <label class="mb-3 text-gray-700 form-label fw-bold fs-6">
                    ...
                    <textarea name="why_use_description" class="form-control form-control-lg form-control-solid" rows="4" required>{{ old('why_use_description') }}</textarea>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-lg-8">
                        <div class="mb-7">
                            ...
                            <input type="text" name="hero_text"
                                class="form-control form-control-lg form-control-solid"
                                value="{{ old('hero_text') }}" required />
                        </div>
                        <div>
                            <label class="mb-3 text-gray-700 form-label fw-bold fs-6">
                                <i class="ki-outline ki-message-text-2 fs-5 text-warning me-2"></i>Hero Subtext
                            </label>
                            <textarea name="hero_subtext" class="form-control form-control-lg form-control-solid" rows="4">{{ old('hero_subtext') }}</textarea>
                        </div>
                    </div>
