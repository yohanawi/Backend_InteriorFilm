<x-default-layout>
    ...
    @section('breadcrumbs')
        {{ Breadcrumbs::render('catalog.catalogs.create') }}
    @endsection


    <div>
        <form id="createCatalogForm" action="{{ route('catalog.catalogs.store') }}" method="POST"
            ...
            <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                <div class="mb-1 row">
                    ...
                    <div class="col-lg-6">
                        ...
                        <input type="text" name="slug" class="form-control @error('slug') is-invalid @enderror"
                            placeholder="Enter slug (optional, will be auto-generated)" value="{{ old('slug') }}" />
                ...
                <div class="d-flex justify-content-end">
                    ...
                    <button type="submit" class="btn btn-primary" id="submitBtn">
                        <span class="indicator-label">Create Catalog</span>
    ...
    @push('scripts')
        <script>
            $(document).ready(function() {
                ...
                $('#createCatalogForm').on('submit', function(e) {
                    e.preventDefault();
