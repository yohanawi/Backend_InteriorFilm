...
use App\Http\Controllers\Api\NgeniusWebhookController;
...
Route::prefix('v1')->group(function () {
    ...
    Route::prefix('products')->group(function () {
        ...
        Route::get('/popular', [ProductController::class, 'popular'])->name('api.products.popular');
        Route::get('/{identifier}', [ProductController::class, 'show'])->name('api.products.show');
    });
});

// Webhook routes (no auth middleware as webhooks come from external services)
Route::post('/webhooks/ngenius', [NgeniusWebhookController::class, 'handle'])
    ->name('webhooks.ngenius');
